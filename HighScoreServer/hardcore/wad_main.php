...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><div class='header'><span style='color:red;font-style:italic;'>Hardcore</span> <span style='color:rgb(156, 156, 222);'>Mode: </span>Hi Score Table</div>(server recognized wad configurations)";

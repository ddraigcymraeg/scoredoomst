...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:rgb(156, 156, 222);'>Regular Mode: </span>".$_GET["wadtitle"]." Level Hi Score Table</p>";
}else{
	echo "<p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:rgb(156, 156, 222);'>Regular Mode: </span>Latest Level Hi Scores Set</p>";
}

...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<p class='header_small'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br>'".$_GET["wadtitle"]."' <span style='color:red;font-style:italic;'>Hardcore</span> Level Hi Score Table</p>";
}else{

...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	...
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br>Latest <span style='color:red;font-style:italic;'>Hardcore</span> Level Hi Scores Set</p>";
}
...
<a class="back" href="http://www.scoredoom.com">back</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main.php">view hardcore wad hi score table</a>
</center>
<div style="position:absolute;top:45px;left:15px;text-align:center;width:360px;">
<a id="hscontrols" href="http://www.scoredoom.com">Back</a>
</div>

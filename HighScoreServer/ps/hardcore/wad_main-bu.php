...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><div class='header'><span style='color:red;font-style:italic;'>Hardcore</span> Hi Score Table</div>(server recognized wad configurations)";

...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70;font-size:16pt;font-weight:bold;'>Pistol Start Mode</span><div class='header'><span style='color:red;font-style:italic;'>Hardcore</span> <span style='color:rgb(156, 156, 222);'>Mode: </span>Hi Score Table</div>(server recognized wad configurations)";
...
<br>
<a class="back" href="#" onclick="window.close()">close</a><!--&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main_public.php">view public hardcore hi score table</a> -->
</center>

...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	...
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br><span style='color:red;font-style:italic;'>Hardcore</span> <span style='color:rgb(156, 156, 222);'>Mode: </span>Latest Level Hi Scores Set</p>";
}
...
<a class="back" href="#" onclick="window.close();">close</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main.php">view hardcore wad hi score table</a>
</center>

...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><div class='header'><span style='font-style:italic;'>Non-Infighting</span> Hi Score Table</div>(server recognized wad configurations)";
...
<br>
<a class="back" href="http://www.scoredoom.com">back</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main_public.php">view <span style='font-style:italic;'>Non-Infighting</span> public hi score table</a>
</center>
...
<a id="hscontrols" href="wad_main_level_latest.php">View the Latest <span style='color:white;'>Non-Infighting</span> Level Hi Scores Set</a>
</div>

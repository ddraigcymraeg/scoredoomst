...
echo "<a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><div class='header'>Public <span style='font-style:italic;'>Non-Infighting</span>&nbsp;<span style='color:red;font-style:italic;'>Hardcore</span> Hi Score Table</div>(player added wad configurations)";
...
while($row = mysql_fetch_assoc($result))
{
   ...
   echo "<tr style='background-color:".$bgcolor."';>";
	...
	echo "<td class='lvlslink'><a href='wad_main_level_public.php?wadhash=".$row['wadhash']."&addonpack_hash=".$row['addonpack_hash']."&epi=".$row['episode']."&wadtitle=".urlencode($name)."' title='Click here to see the ".$name." level hi scores'>".$wadsepi."</a></td><td class='smalltext'>".$patches."</td>";
...
<br>
<a class="back" href="http://www.scoredoom.com">back</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main.php">view main <span style='font-style:italic;'>Non-Infighting</span>&nbsp;hardcore hi score table</a>
</center></body></html>
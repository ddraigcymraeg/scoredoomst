...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70;font-size:16pt;font-weight:bold;'>Pistol Start Mode</span><br><span style='color: rgb(156, 156, 222); font-weight: bold; font-size: 13pt;'>Regular w. <span style='color: white;'>Non-Infighting</span> Mode: </span><br> <span style='color: white;font-size:13pt;font-weight:bold;'>Hi Score Table</span></div><br>(server recognized wad configurations)";
...
<br>
<a class="back" href="#" onclick="window.close();">close</a><!--&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main_public.php">view <span style='font-style:italic;'>Non-Infighting</span> public hi score table</a>-->
</center>

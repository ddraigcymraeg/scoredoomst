...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<a href='http://www.scoredoom.com'><p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br>'".$_GET["wadtitle"]."' Level Hi Score Table</p>";
}else{
	echo "<a href='http://www.scoredoom.com'><p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br>ScoreDoom Level Hi Score Table</p>";
}
...
<a class="back" href="javascript:history.go(-1);">back</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main.php">view <span style='font-style:italic;'>Non-Infighting</span> wad hi score table</a>
</center>

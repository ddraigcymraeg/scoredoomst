...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	...
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br><span style='color: rgb(156, 156, 222); font-weight: bold;'>Regular w. <span style='color: white;'>Non-Infighting</span> Mode: <br></span>Latest Level Hi Scores Set</p>";
}

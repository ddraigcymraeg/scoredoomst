...
echo "<div class='header'><a href='http://www.scoredoom.com'><img height='30px;' border='0' src='images/scoredoom.gif'></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br><span style='color:rgb(156, 156, 222);'>Regular Mode: </span>Hi Score Table</div>(server recognized wad configurations)";

...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	...
	echo "<a href='http://www.scoredoom.com'><img height='30px;' border='0' src='images/scoredoom.gif'></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br><h2>'".$_GET["wadtitle"]."' Level Hi Score Table</h2></p>";
}else{
	echo "<a href='http://www.scoredoom.com'><img height='30px;' border='0' src='images/scoredoom.gif'></a><br><span style='color:#93DB70'>Pistol Start Mode</span><br><h2>ScoreDoom Official Wad Hi Score Table<h2></p>";
}

...
echo "<a href='http://www.scoredoom.com'><img height='30px;' border=0 src='images/scoredoom.gif'/></a><br><span style='color: rgb(156, 156, 222); font-weight: bold; font-size: 13pt;'><span style='color: red;'>Hardcore</span> w. <span style='color: white;'>Non-Infighting</span> Mode: </span><br> <span style='color: white;font-size:13pt;font-weight:bold;'>Hi Score Table</span></div><br>(server recognized wad configurations)";

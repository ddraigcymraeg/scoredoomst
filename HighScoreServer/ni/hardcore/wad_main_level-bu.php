...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>'".$_GET["wadtitle"]."' <span style='color:red;font-style:italic;'>Hardcore</span> Level Hi Score Table</p>";
}else{
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>ScoreDoom Official Wad Hi Score Table</p>";
}

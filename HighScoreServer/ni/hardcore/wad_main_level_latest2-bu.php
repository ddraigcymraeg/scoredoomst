...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	...
	echo "<p class='header'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>Latest <span style='color:red;font-style:italic;'>Hardcore</span> Level Hi Scores Set</p>";
}

...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<a href='http://www.scoredoom.com'><p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>'".$_GET["wadtitle"]."' Level Hi Score Table</p>";
}else{
	echo "<a href='http://www.scoredoom.com'><p class='header'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>ScoreDoom Level Hi Score Table</p>";
}

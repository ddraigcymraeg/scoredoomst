...
if(isset($_GET["wadtitle"])&&$_GET["wadtitle"]!=""){
	echo "<p class='header_small'><a href='http://www.scoredoom.com'><img height='25px;' border=0 src='images/scoredoom.gif'/></a><br>'".$_GET["wadtitle"]."' <span style='font-style:italic;'>Non-Infighting</span>&nbsp;Level Hi Score Table</p>";
}else{

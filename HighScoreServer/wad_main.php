...
echo "<div class='header'><a href='http://www.scoredoom.com'><img height='30px;' border='0' src='images/scoredoom.gif'></a><br><span style='color:rgb(156, 156, 222);'>Regular Mode: </span>Hi Score Table</div>(server recognized wad configurations)";
echo "<br><br><br><table border='1' class='hiscoreTable'><tr>";
...
<br>
<a class="back" href="#" onclick="window.close();" >Close</a><!--&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a class="back" href="wad_main_public.php">view public hi score table</a>
-->
</center>
...
<td ALIGN=LEFT><a href="wad_main.php?" id="hscontrols">Default view</a>
</td></tr><tr><td>

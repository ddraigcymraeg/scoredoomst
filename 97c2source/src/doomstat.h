...
extern	int			sd_finale_nextmap_state; //ghk
extern  int			didonce; //ghk

extern bool sd_do_default_monsters; //ghk
...
//extern const char *sd_serveraddonpack_md5;
//extern const char *sd_clientaddonpack_md5; //ghk

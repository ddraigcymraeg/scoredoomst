...
struct sector_t
{
	...
	int			floorpic, ceilingpic; //ghk was short
	BYTE		lightlevel;
	...
	bool	bFlatChange;
	int		SavedFloorPic; //ghk was short
	int		SavedCeilingPic; //ghk was short
...
struct side_s
{
	...
	int			toptexture, bottomtexture, midtexture;	// texture indices //ghk was short
	WORD		linenum;
	...
	int		SavedTopTexture; //ghk was short
	int		SavedMidTexture; //ghk was short
	int		SavedBottomTexture; //ghk was short

...
//	DF2_YES_IMPALING		= 1 << 0,	// Player gets implaed on MF2_IMPALE items
	...
	//All Barons become Baron Boss-Rush Chains (add-on pack).
	DF2_BRUISER_RUSH		= 1 << 13,
	//All Cyberdemons become Cyberdemon Boss-Rush Chains (add-on pack).
	DF2_CYBER_RUSH			= 1 << 14,
	//All Spider Masterminds become Spider Mastermind Boss-Rush Chains (add-on pack).
	DF2_SPIDER_RUSH			= 1 << 15,

	DF2_COOP_WARPTO			= 1 << 16, //ghk

	DF2_AGGRESSIVE_BOSSES	= 1 << 17, //ghk all barons, cybs, spidmasters, and their add-on pack replacements

	DF2_NO_ALTFIRE			= 1 << 18, //ghk DISABLE ALTFIRE MODES
...
enum
{
	...
	COMPATF_FORCEBLOCKMONSTER   = 1 << 23,

...
#define	QUADDAMAGE_TICS			( 35 * TICRATE )
#define	QUARTERDAMAGE_TICS		( 35 * TICRATE )
#define	TRANSLUCENCY_TICS		( 45 * TICRATE )

//GHK
#define	DOUBLEDAMAGE_TICS		( 35 * TICRATE )
#define	RAGE_TICS				( 35 * TICRATE )
#define	DRAIN_TICS				( 35 * TICRATE )
#define	SPREAD_TICS				( 35 * TICRATE )
#define	HALFDAMAGE_TICS			( 35 * TICRATE )
#define	REGEN_TICS				( 35 * TICRATE )
#define	REFLECTION_TICS			( 35 * TICRATE )
#define	HIGHJUMP_TICS			( 45 * TICRATE )
#define	FRIGHTENER_TICS			( 20 * TICRATE )
...
IMPLEMENT_STATELESS_ACTOR (APowerFrightener, Any, -1, 0)
	PROP_Powerup_EffectTics (FRIGHTENER_TICS)
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerDoubleDamage, Any, -1, 0 )
	PROP_Powerup_EffectTics (DOUBLEDAMAGE_TICS)
END_DEFAULTS
...
void APowerDoubleDamage::InitEffect( )
{
...
void APowerDoubleDamage::EndEffect( )
{
	// Nothing to do if there's no owner.
	if (( Owner == NULL ) || ( Owner->player == NULL ))
	{
...
PROP_Powerup_EffectTics (DRAIN_TICS)
END_DEFAULTS
...
{
	// Give the player the power to shoot 3x the number of missiles he normally would.
	Owner->player->Powers |= PW_INFINITEAMMO;
}
...
IMPLEMENT_STATELESS_ACTOR( APowerHalfDamage, Any, -1, 0 )
PROP_Powerup_EffectTics (HALFDAMAGE_TICS)
END_DEFAULTS
...
void APowerHalfDamage::InitEffect( )
{
...
void APowerHalfDamage::EndEffect( )
{
	// Nothing to do if there's no owner.
	if (( Owner == NULL ) || ( Owner->player == NULL ))
	{
...
PROP_Powerup_EffectTics (REGEN_TICS)
END_DEFAULTS
...
PROP_Powerup_EffectTics (HIGHJUMP_TICS)
END_DEFAULTS
...
//		return;
	...
	if ( gameinfo.gametype == GAME_Doom )
	{
		...
		{
//			Printf( "%s wearing off...\n", this->GetClass( )->TypeName.GetChars( ));
			Printf( TEXTCOLOR_LIGHTBLUE"High-jump wearing off...\n" );
		}
	}
